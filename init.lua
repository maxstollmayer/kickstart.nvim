...
vim.g.python3_host_prog =
  'C:\\Users\\maxst\\.pyenv\\pyenv-win\\versions\\3.10.11\\python.exe'
...
vim.opt.title = true
vim.opt.titlestring = [[%t in %{fnamemodify(getcwd(), ':~:.')}]]
...
require('lazy').setup {
  ...
  { -- colorscheme, see `:Telescope colorscheme` for all available ones
    'catppuccin/nvim',
    name = 'catppuccin',
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- disable the section for cursor information
